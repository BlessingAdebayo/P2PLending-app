...
class LoanOffer extends Component {
  ...
  render() {
    ...
    height:'100vh'}
    return (
      <div className="LoanOffer text-center text-white fw-bold" style={myStyle}>
        <Header />
          ...
          <section className="section-hero section-shaped my-0">
            ...
            <div className="container d-flex">
              <div className="col-lg-7">
                <div className="border border-white card bg-transparent fw-bold text-white ">
              ...
              <div className="col-md-5">
                <div className="border border-white card bg-transparent fw-bold text-white">
                  ...
                  <div className="card-header text-left text-dark">
