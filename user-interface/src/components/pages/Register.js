...
import welllo5 from '../images/coni2.png' 
import {
  CURRENCIES,
  LOOKING,
  SERVICES,
...
export default function Register(props) {
  ...
  const myStyle= {backgroundImage: `url(${welllo5})`,
  backgroundSize:'cover'}
  const myStyle1= {backgroundImage: `url(${welllo4})`,
  backgroundSize:'cover'
 }
  return (
    <>
      <Navbar />
      <div className="main-content"style={myStyle1} >
        <div className="header  py-5" style={myStyle}>
          <div className="container">
            <div className="header-body text-center">
              <div className="row justify-content-center">
                <div className=" col-lg-6 col-md-8 px-5">
                  <h2 className="text-white fw-bolder">Register</h2>
                  <p className="text-lead text-white fw-bold fw-bolder">
        ...
        <div className="container mt-5 pb-5">
          <div className="row justify-content-center">
            <div className="col-md-10 col-lg-8 col-12">
              <div className="card text-white border-0" style={{backgroundColor:'#01154E'}}>
